! function(e, t) {
    ...
    const X = {
        ...
        G = (e, t, n) => {
            var o, i;
            if (o = e, i = t, r(o.classList).forEach(e => {
        ...
        ve = () => {
            const e = g(),
                ...
                s = oe(e, p.textarea);
            t.oninput = be, n.onchange = be, a.onchange = be, r.onchange = be, s.oninput = be, o.oninput = () => {
                be(), i.value = o.value
            }, o.onchange = () => {
    ...
    const pt = () => {
        ...
        At = (t, n) => {
            ...
            C(n.inputOptions) || A(n.inputOptions) ? (kt(V()), k(n.inputOptions).then(e => {
                t.hideLoading(), i(e)
    ...
    function Gt(e, t, n, o) {
        Z() ? nn(e, o) : (ge(n).then(() => nn(e, o)), f.keydownTarget.removeEventListener("keydown", f.keydownHandler, {
    ...
    const dn = (l, u, d) => new Promise((e, t) => {
            ...
            $t.swalPromiseResolve.set(l, e), $t.swalPromiseReject.set(l, t), u.confirmButton.onclick = () => {
            ...
            }, u.closeButton.onclick = () => n($e.close), e = l, t = u, a = n, b.innerParams.get(e).toast ? Mt(e, t, a) : (It(t), Ht(t), qt(e, t, a)), o = l, e = f, t = d, i = n, e.keydownTarget && e.keydownHandlerAdded && (e.keydownTarget.removeEventListener("keydown", e.keydownHandler, {
                capture: e.keydownListenerCapture
            }), e.keydownHandlerAdded = !1), t.toast || (e.keydownHandler = e => Ut(o, e, i), e.keydownTarget = t.keydownListenerCapture ? window : g(), e.keydownListenerCapture = t.keydownListenerCapture, e.keydownTarget.addEventListener("keydown", e.keydownHandler, {
                capture: e.keydownListenerCapture
                ...
                const s = m(),
                    c = g();
                "function" == typeof r.willOpen && r.willOpen(c), e = window.getComputedStyle(document.body).overflowY, Ct(s, c, r), setTimeout(() => {
                    yt(s, c)
                }, bt), Y() && (wt(s, r.scrollbarPadding, e), Ge()), Z() || f.previousActiveElement || (f.previousActiveElement = document.activeElement), "function" == typeof r.didOpen && setTimeout(() => r.didOpen(c)), ne(s, p["no-transition"])
            }
            gn(f, d, n), hn(u, d), setTimeout(() => {
        ...
        gn = (e, t, n) => {
            var o = z();
            h(o), t.timer && (e.timeout = new dt(() => {
                n("timer"), delete e.timeout
            }, t.timer), t.timerProgressBar && (d(o), setTimeout(() => {
        ...
        vn = (Object.assign(un.prototype, cn), Object.assign(un, e), Object.keys(cn).forEach(e => {
            un[e] = function() {
...
(document, 
    ...
    .swal2-styled.swal2-confirm:focus {
        box-shadow: 0 0 0 3px rgb(194 102 224 / 50%)
    }
    ...
    .swal2-icon.swal2-success .swal2-success-ring {
        ...
        width: 100%;
        height: 100%;
        border: .25em solid rgb(220 134 211 / 30%);
        border-radius: 50%
    }
