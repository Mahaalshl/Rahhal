...
@section('body')
    ...
    <div class="bradcam_area breadcam_bg_2">
        <h3>{{__('messages.PlacesCreate')}}</h3>
    </div>
    <!-- bradcam_area_end -->
    ...
    <section class="contact-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">{{__('messages.PlacesPage')}} </h2>
                </div>
                <div class="col-lg-8">
                    <form class="" action="" method="post" id="contactForm" enctype="multipart/form-data"
...
@csrf
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" class="button button-contactForm boxed-btn">{{__('messages.PlaceCreateSend')}} </button>
                        </div>
                    </form>
                </div>
            </div>
