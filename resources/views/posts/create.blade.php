...
@section('body')
    ...
    <div class="bradcam_area breadcam_bg_2">
        <h3>{{__('messages.PostPageCreatePost')}}</h3>
    </div>
    <!-- bradcam_area_end -->
    ...
    <section class="contact-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">{{__('messages.PostPageCreateNewPost')}}</h2>
                </div>
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="" method="post" id="contactForm" enctype="multipart/form-data"
                        ...
                        <div class="form-group mt-3">
                           <a href="#contactForm"><button type="submit" class="button button-contactForm boxed-btn">{{__('messages.PostCreateSend')}}</button></a> 
                        </div>
                    </form>
                </div>
            </div>
